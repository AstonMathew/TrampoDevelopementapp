...
public class SendEmail {
  /**
   * Note: Only work if the setting "Access for less secure apps" is ON in gmail Access at
   * https://myaccount.google.com/security set up dual factor authentiocation in account and
   * generate app password. register app. put password in code.
   */
  ...
  public void send(String to, String subject, String text) {
    try {
      ...
      _session = Session.getInstance(_props, new javax.mail.Authenticator() {
